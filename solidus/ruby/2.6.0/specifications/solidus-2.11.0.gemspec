...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<solidus_backend>.freeze, ["= 2.11.0"])
      s.add_runtime_dependency(%q<solidus_core>.freeze, ["= 2.11.0"])
      s.add_runtime_dependency(%q<solidus_frontend>.freeze, ["= 2.11.0"])
      s.add_runtime_dependency(%q<solidus_sample>.freeze, ["= 2.11.0"])
    else
      s.add_dependency(%q<solidus_api>.freeze, ["= 2.11.0"])
      s.add_dependency(%q<solidus_backend>.freeze, ["= 2.11.0"])
      s.add_dependency(%q<solidus_core>.freeze, ["= 2.11.0"])
      s.add_dependency(%q<solidus_frontend>.freeze, ["= 2.11.0"])
      s.add_dependency(%q<solidus_sample>.freeze, ["= 2.11.0"])
    end
  else
    s.add_dependency(%q<solidus_api>.freeze, ["= 2.11.0"])
    s.add_dependency(%q<solidus_backend>.freeze, ["= 2.11.0"])
